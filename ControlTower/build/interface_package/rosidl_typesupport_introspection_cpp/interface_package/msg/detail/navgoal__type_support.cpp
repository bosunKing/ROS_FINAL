...
{
  new (message_memory) interface_package::msg::Navgoal(_init);
}

void Navgoal_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface_package::msg::Navgoal *>(message_memory);
  typed_message->~Navgoal();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Navgoal_message_member_array[3] = {
  {
    "order_id",  // name
    ...
    offsetof(interface_package::msg::Navgoal, order_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface_package::msg::Navgoal, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface_package::msg::Navgoal, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Navgoal_message_members = {
  ...
  3,  // number of fields
  sizeof(interface_package::msg::Navgoal),
...
{
  return &::interface_package::msg::rosidl_typesupport_introspection_cpp::Navgoal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface_package, msg, Navgoal)() {
  return &::interface_package::msg::rosidl_typesupport_introspection_cpp::Navgoal_message_type_support_handle;
}
