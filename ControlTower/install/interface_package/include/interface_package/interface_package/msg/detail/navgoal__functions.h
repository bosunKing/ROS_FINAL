...
#ifndef INTERFACE_PACKAGE__MSG__DETAIL__NAVGOAL__FUNCTIONS_H_
#define INTERFACE_PACKAGE__MSG__DETAIL__NAVGOAL__FUNCTIONS_H_
 ...
 * calls
 * interface_package__msg__Navgoal__init().
...
/**
 * It calls
 * interface_package__msg__Navgoal__fini()
 ...
 * interface_package__msg__Navgoal__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * interface_package__msg__Navgoal__Sequence__fini()
 * on the array,
...
#endif  // INTERFACE_PACKAGE__MSG__DETAIL__NAVGOAL__FUNCTIONS_H_
