...
#ifndef INTERFACE_PACKAGE__SRV__DETAIL__GOAL_ARRIVAL__FUNCTIONS_H_
#define INTERFACE_PACKAGE__SRV__DETAIL__GOAL_ARRIVAL__FUNCTIONS_H_
...
/// Initialize srv/GoalArrival message.
/**
...
/// Finalize srv/GoalArrival message.
/**
...
/// Create srv/GoalArrival message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interface_package__srv__GoalArrival_Request__init().
...
/// Destroy srv/GoalArrival message.
/**
 * It calls
 * interface_package__srv__GoalArrival_Request__fini()
...
/// Check for srv/GoalArrival message equality.
/**
...
/// Copy a srv/GoalArrival message.
/**
...
/// Initialize array of srv/GoalArrival messages.
/**
...
/// Finalize array of srv/GoalArrival messages.
/**
 * It calls
 * interface_package__srv__GoalArrival_Request__fini()
...
/// Create array of srv/GoalArrival messages.
/**
 * It allocates the memory for the array and calls
 * interface_package__srv__GoalArrival_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GoalArrival messages.
/**
 * It calls
 * interface_package__srv__GoalArrival_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GoalArrival message array equality.
/**
...
/// Copy an array of srv/GoalArrival messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interface_package__srv__GoalArrival_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interface_package
...
/**
 * It calls
 * interface_package__srv__GoalArrival_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_interface_package
...
/**
 * It allocates the memory for the array and calls
 * interface_package__srv__GoalArrival_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interface_package
...
/**
 * It calls
 * interface_package__srv__GoalArrival_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTERFACE_PACKAGE__SRV__DETAIL__GOAL_ARRIVAL__FUNCTIONS_H_
