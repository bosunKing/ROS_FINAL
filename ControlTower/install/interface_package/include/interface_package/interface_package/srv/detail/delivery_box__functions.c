...
interface_package__srv__DeliveryBox_Request__init(interface_package__srv__DeliveryBox_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->order_id)) {
    interface_package__srv__DeliveryBox_Request__fini(msg);
    return false;
  }
  // robot_id
...
interface_package__srv__DeliveryBox_Request__create()
{
  ...
  interface_package__srv__DeliveryBox_Request * msg = (interface_package__srv__DeliveryBox_Request *)allocator.allocate(sizeof(interface_package__srv__DeliveryBox_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interface_package__srv__DeliveryBox_Request));
  bool success = interface_package__srv__DeliveryBox_Request__init(msg);
  if (!success) {
...
interface_package__srv__DeliveryBox_Request__Sequence__init(interface_package__srv__DeliveryBox_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interface_package__srv__DeliveryBox_Request * data = NULL;

  if (size) {
    data = (interface_package__srv__DeliveryBox_Request *)allocator.zero_allocate(size, sizeof(interface_package__srv__DeliveryBox_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interface_package__srv__DeliveryBox_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        interface_package__srv__DeliveryBox_Request__fini(&data[i - 1]);
      }
...
interface_package__srv__DeliveryBox_Request__Sequence__fini(interface_package__srv__DeliveryBox_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      interface_package__srv__DeliveryBox_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interface_package__srv__DeliveryBox_Request__Sequence * array = (interface_package__srv__DeliveryBox_Request__Sequence *)allocator.allocate(sizeof(interface_package__srv__DeliveryBox_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interface_package__srv__DeliveryBox_Request__Sequence__init(array, size);
  if (!success) {
...
interface_package__srv__DeliveryBox_Request__Sequence__destroy(interface_package__srv__DeliveryBox_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interface_package__srv__DeliveryBox_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
interface_package__srv__DeliveryBox_Request__Sequence__are_equal(const interface_package__srv__DeliveryBox_Request__Sequence * lhs, const interface_package__srv__DeliveryBox_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interface_package__srv__DeliveryBox_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interface_package__srv__DeliveryBox_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interface_package__srv__DeliveryBox_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interface_package__srv__DeliveryBox_Request * data =
      (interface_package__srv__DeliveryBox_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interface_package__srv__DeliveryBox_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interface_package__srv__DeliveryBox_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!interface_package__srv__DeliveryBox_Request__copy(
...
interface_package__srv__DeliveryBox_Response__init(interface_package__srv__DeliveryBox_Response * msg)
{
  ...
  // robot_id
  if (!rosidl_runtime_c__String__init(&msg->robot_id)) {
    interface_package__srv__DeliveryBox_Response__fini(msg);
    return false;
  }
  // success
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interface_package__srv__DeliveryBox_Response * msg = (interface_package__srv__DeliveryBox_Response *)allocator.allocate(sizeof(interface_package__srv__DeliveryBox_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interface_package__srv__DeliveryBox_Response));
  bool success = interface_package__srv__DeliveryBox_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
interface_package__srv__DeliveryBox_Response__Sequence__init(interface_package__srv__DeliveryBox_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interface_package__srv__DeliveryBox_Response * data = NULL;

  if (size) {
    data = (interface_package__srv__DeliveryBox_Response *)allocator.zero_allocate(size, sizeof(interface_package__srv__DeliveryBox_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interface_package__srv__DeliveryBox_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        interface_package__srv__DeliveryBox_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
interface_package__srv__DeliveryBox_Response__Sequence__fini(interface_package__srv__DeliveryBox_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      interface_package__srv__DeliveryBox_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interface_package__srv__DeliveryBox_Response__Sequence * array = (interface_package__srv__DeliveryBox_Response__Sequence *)allocator.allocate(sizeof(interface_package__srv__DeliveryBox_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interface_package__srv__DeliveryBox_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
interface_package__srv__DeliveryBox_Response__Sequence__destroy(interface_package__srv__DeliveryBox_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interface_package__srv__DeliveryBox_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
interface_package__srv__DeliveryBox_Response__Sequence__are_equal(const interface_package__srv__DeliveryBox_Response__Sequence * lhs, const interface_package__srv__DeliveryBox_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interface_package__srv__DeliveryBox_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interface_package__srv__DeliveryBox_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interface_package__srv__DeliveryBox_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interface_package__srv__DeliveryBox_Response * data =
      (interface_package__srv__DeliveryBox_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interface_package__srv__DeliveryBox_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interface_package__srv__DeliveryBox_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!interface_package__srv__DeliveryBox_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
